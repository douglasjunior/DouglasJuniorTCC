...
public class RepositoryServices {
    ...
    private static EntityRepository getRepositoryByName(String name, GenericDao dao) {
    ...
    public static EntityRepository createEntity(Repository gitRepository, GenericDao dao) {
        if (gitRepository == null) {
            return null;
        }

        EntityRepository repo = getRepositoryByName(gitRepository.getName(), dao);
        ...
        repo.setParent(RepositoryServices.createEntity(gitRepository.getParent(), dao));
        repo.setSource(RepositoryServices.createEntity(gitRepository.getSource(), dao));
