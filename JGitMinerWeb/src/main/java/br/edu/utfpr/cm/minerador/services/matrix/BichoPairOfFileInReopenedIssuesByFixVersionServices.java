...
public class BichoPairOfFileInReopenedIssuesByFixVersionServices extends AbstractBichoMatrixServices {
    ...
    public BichoPairOfFileInReopenedIssuesByFixVersionServices(GenericBichoDAO dao, GenericDao genericDao, String repository, List<EntityMatrix> matricesToSave, Map<Object, Object> params, OutLog out) {
